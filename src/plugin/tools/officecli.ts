...
import { createDraft, acceptDraft, undoDraft, getHistory, getDraftPath, draftExists, getSnapshot } from "../../core/draft/manager.ts"
import { acquireLock, getLock, releaseLock, isLockStale, overrideLock } from "../../core/draft/lock.ts"
import { getFilePathHash } from "../../core/storage/paths.ts"
import { writeFileSync, readFileSync, existsSync } from "fs"
import { extname, resolve, join } from "path"
import { detectFormat } from "../../core/format/detect.ts"
import { writeComment, readComments, applyCommentSuggestion, type Comment } from "../../core/format/ooxml/comments.ts"
import { writeTrackChange, readTrackChanges, type TrackChange } from "../../core/format/ooxml/trackchanges.ts"
import { writeComment as writeXlsxComment, readComments as readXlsxComments, applyCellSuggestion, type XlsxComment } from "../../core/format/ooxml/xlsxcomments.ts"
import { writeComment as writePptxComment, readComments as readPptxComments, applySlideSuggestion, type PptxComment } from "../../core/format/ooxml/pptxcomments.ts"
import { listActiveDrafts, getDraftSessions } from "../../core/draft/manager.ts"
import { diffTexts } from "../../core/draft/diff.ts"
import { substituteTemplate } from "../../core/template/substitute.ts"
import { readRealFileAsMarkdown } from "../../core/format/read.ts"
import { renderMarkdownFileToHtml } from "../../core/format/render.ts"
