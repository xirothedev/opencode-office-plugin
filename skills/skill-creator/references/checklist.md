# Grill checklist — daily task → Task Skill

Copy this, answer in one line per row.

| # | Question | Your answer |
|---|----------|-------------|
| 1 | YAGNI — can `officecli` copy cover it without a skill? |  |
| 2 | Input — real folder/file path (e.g. `11. MS BỘ.../1. Hồ sơ thầu`) |  |
